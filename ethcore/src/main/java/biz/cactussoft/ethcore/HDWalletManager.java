...
public class HDWalletManager {
	...
	public static byte[] mnemonicToSeed(List<String> mnemonic,
										String passphrase) throws IOException, MnemonicException {
		final MnemonicCode mnemonicCode = new MnemonicCode();
	 ...
	 */
	public static String buildPath(int purpose,
								   int coin,
								   int account,
								   int change) {
	...
	public static List<ChildNumber> convertPath(String path) throws IncorrectDerivationPathException {
		...
		final String[] indexes = path.split("/");
		final List<ChildNumber> list = new ArrayList<>();
	 ...
	 */
	public static DeterministicKey getChildKey(DeterministicKey masterKey,
											   List<ChildNumber> path,
											   ChildNumber index) {
		final DeterministicHierarchy hierarchy = new DeterministicHierarchy(masterKey);
	...
	public static DeterministicKey getChildKey(DeterministicKey masterKey,
											   String path,
											   int index) throws IncorrectDerivationPathException {
	 ...
	 * @return generated deterministic key
	 */
	public static List<DeterministicKey> getChildKeys(DeterministicKey masterKey,
													  List<ChildNumber> path,
													  int startIndex,
													  int count) {
		final DeterministicHierarchy hierarchy = new DeterministicHierarchy(masterKey);
		final List<DeterministicKey> list = new ArrayList<>();
	...
	public static List<DeterministicKey> getChildKeys(DeterministicKey masterKey,
													  String path,
													  int startIndex,
													  int count) throws IncorrectDerivationPathException {
